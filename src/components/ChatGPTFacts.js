...
function ChatGPTFacts() {
  return (
    <div className="container h-auto mx-auto" id="chatGPTFacts">
      <div className="p-4 bg-zinc-800 h-fit">
        <div className="flex flex-col bg-zinc-800">
          <h2 className="mb-4 text-2xl font-bold text-white bg-zinc-800">ChatGPTFacts</h2>
          <div className="flex flex-col ">
            <div className="flex p-2 m-2 text-white bg-gray-900 bg-opacity-50 border rounded-lg hover:border-orange-500 hover:border-4">
